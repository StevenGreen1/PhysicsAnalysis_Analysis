...
### ----------------------------------------------------------------------------------------------------
    ...
    def getCondorJobString(self, idx, arguement):
        ...
        jobString += 'output                  = ' + os.environ['HOME'] + '/CondorLogs/Fitting_' + self._ExecutableName[-3] + '_' + '_'.join(arguement.split(' ')[-1]) + '.out  \n'
        jobString += 'error                   = ' + os.environ['HOME'] + '/CondorLogs/Fitting_' + self._ExecutableName[-3] + '_' + '_'.join(arguement.split(' ')[-1]) + '.err \n'
        jobString += 'log                     = ' + os.environ['HOME'] + '/CondorLogs/Fitting_' + self._ExecutableName[-3] + '_' + '_'.join(arguement.split(' ')[-1]) + '.log \n'
