...
//    MakeDerivedPlots *makePlots = new MakeDerivedPlots(processes, "3000GeV_PostPreSelection_PostMVA_Cuts", pPreSelectionSemiFinal, pPostMVASelection); // Remove for condor jobs
